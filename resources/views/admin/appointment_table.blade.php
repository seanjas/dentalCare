                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <button class="btn btn-success btn-sm" id="add-appointment-btn">
                              <i class="mdi mdi-plus"></i> Add Appointment
                            </button>
                          </div>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$appointments->new_date_column}}</td>
                                    <td>{{$appointments->new_time_column}}</td>
                                  <td>
